...
|---------|-----------|-----------------|---------------------|
| **База анекдотов** | ~10k анекдотов | ~100k+ анекдотов | Собственная база |
| **Поиск** | Ключевые слова | Ключевые слова | Векторный поиск + теги |
| **Рейтинги** | Нет | Нет | Система рейтингов + средний рейтинг |
| **Теги** | Нет | Нет | Автогенерация тегов |
| **Дубликаты** | Нет | Нет | Дедупликация |

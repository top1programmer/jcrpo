...
- [1 Введение](#1-введение)
  ...
  - [1.3 Аналоги](#13-аналоги)
    - [1.3.1 Исходные данные](#131-JokesBot)
    - [1.3.2 Возможности бизнеса](#132-anekdot_ru_bot)
    - [1.3.3 Сравнение аналогов](#133-Сравнение аналогов)    
...
Простой Telegram-бот, который отправляет случайные анекдоты или шутки по ключевым словам. Использует JokeAPI для получения контента. Базовый функционал: рандомная шутка, поиск по словам. Нет рейтингов, тегов, редактирования или ML-функций. Подходит для быстрого развлечения в чатах.

#### 1.3.2 anekdot_ru_bot
Telegram-бот, агрегирующий анекдоты с популярного сайта anekdot.ru. Реагирует на команду "анекдот" в группах, присылая свежие шутки. Имеет большую базу (~100k+ анекдотов), но ограничен текстовым поиском по ключевым словам. Нет пользовательских рейтингов, тегов или модерации контента

#### 1.3.3 Сравнение аналогов

| Функция | @JokesBot | @anekdot_ru_bot | JokeHub |
|---------|-----------|-----------------|---------------------|
| **База анекдотов** | ~10k анекдотов | ~100k+ анекдотов | Собственная база с векторными embeddings |
| **Поиск** | Только по ключевым словам | Только по ключевым словам | Векторный поиск + NER + теги |
| **Рейтинги** | Нет | Нет | Система рейтингов + средний рейтинг |
| **Теги** | Нет | Нет | Автогенерация тегов + кластеризация |
| **Дубликаты** | Нет | Нет | Дедупликация по canonical_id |
| **Редактирование** | Нет | Нет | Веб-интерфейс редактирования |
...
Главная веб страница приложения<br>
![Вебсайт](../../images/main.png)

Мобильная версия главной страницы приложения<br>
![Мобильная версия](../../images/mobile.png)

Cтраница входа/регистрации<br>
![Страница входа](../../images/login.png)

Главная страница после входа/регистрации<br>
![Главная страница после входа/регистрации](../../images/is_logged_in.png)

Телеграмм бот <br>
![Телеграмм бот](../../images/tg_bot.png)

Окно редактирования<br>
![Окно редактирования](../../images/edit_joke.png)

Окно подтверждения удаления<br>

![Окно подтверждения удаления](../../images/confirmation.png)

...
## 0 Глоссарий
0.1 Анекдот — текстовая запись юмористического содержания, отображаемая и хранящаяся в системе.
0.2 Тег — ключевое слово или категория, связанная с анекдотом и используемая для поиска и фильтрации.
0.3 Пользователь — человек, взаимодействующий с системой через веб-интерфейс или Telegram-бота.
0.4 Авторизованный пользователь — пользователь, имеющий возможность добавлять и редактировать анекдоты.
0.5 Telegram-бот — программный интерфейс в мессенджере Telegram, предоставляющий доступ к функциям системы.
...
#### 3.1.4  Получение случайного анекдота.
